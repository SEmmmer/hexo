---
title: "Z9 内存卡连拍实测：两卡近似同速，双卡同写更早降速"
date: 2026-09-18 16:42:56
categories:
  - 摄影器材
tags:
  - Nikon Z9
  ...
  - 存储卡
  - 连拍测试
description: Nikon Z9 两张 CFexpress Type B 存储卡的六个工况连拍实测，比较单卡换槽与双卡备份在前 30 秒内的帧率、首次延迟和曝光数量。
---
...
![Z9 六个工况的前 30 秒连拍记录范围，黄色菱形标记首次超过 60 ms 的帧间隔](/downloads/z9-memory-card-burst-test-20260917/assets/burst_timeline_60ms.png)
...
<div class="article-table-scroll" tabindex="0" role="region" aria-label="可横向滚动的数据表 1">
...
<div class="article-table-scroll" tabindex="0" role="region" aria-label="可横向滚动的数据表 2">
...
<div class="article-table-scroll" tabindex="0" role="region" aria-label="可横向滚动的数据表 3">
...
<div class="article-table-scroll" tabindex="0" role="region" aria-label="可横向滚动的数据表 4">
...
<div class="article-table-scroll" tabindex="0" role="region" aria-label="可横向滚动的数据表 5">
...
<p class="article-downloads">{% url_for "Markdown 原文" /downloads/z9-memory-card-burst-test-20260917/index.md %} · {% url_for "SVG 主图" /downloads/z9-memory-card-burst-test-20260917/assets/burst_timeline_60ms.svg %} · {% url_for "数据摘要" /downloads/z9-memory-card-burst-test-20260917/data/summary.json %}</p>
